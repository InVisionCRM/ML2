...
export function GamesSection() {
  return (
    <main className="w-full px-4 py-16 relative z-10">
      {/* Large Title */}
      ...
      <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-8 max-w-6xl mx-auto relative">
        ...
        <Link href="/keno" className="group block">
          <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-blue-900/20 to-blue-600/20 backdrop-blur-sm border border-blue-500/30 hover:border-transparent transition-all duration-300 hover:scale-105 h-48 w-48 sm:h-64 sm:w-64 lg:h-80 lg:w-80 group-hover:shadow-[0_0_30px_rgba(59,130,246,0.4)] before:absolute before:inset-0 before:rounded-2xl before:p-[2px] before:bg-gradient-to-r before:from-red-500 before:via-yellow-500 before:via-green-500 before:via-blue-500 before:via-purple-500 before:to-red-500 before:opacity-0 hover:before:opacity-100 before:transition-opacity before:duration-300">
            <div className="relative h-full w-full rounded-2xl overflow-hidden">
              <Image
        ...
        <Link href="/PLINKO" className="group block">
          <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-green-900/20 to-green-600/20 backdrop-blur-sm border border-green-500/30 hover:border-transparent transition-all duration-300 hover:scale-105 h-48 w-48 sm:h-64 sm:w-64 lg:h-80 lg:w-80 group-hover:shadow-[0_0_30px_rgba(34,197,94,0.4)] before:absolute before:inset-0 before:rounded-2xl before:p-[2px] before:bg-gradient-to-r before:from-red-500 before:via-yellow-500 before:via-green-500 before:via-blue-500 before:via-purple-500 before:to-red-500 before:opacity-0 hover:before:opacity-100 before:transition-opacity before:duration-300">
            {/* NEW! Badge */}
        ...
        <div className="group block relative">
          <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-gray-900/30 to-gray-700/30 backdrop-blur-md border border-gray-500/20 h-48 w-48 sm:h-64 sm:w-64 lg:h-80 lg:w-80">
            <div className="relative h-full w-full rounded-2xl overflow-hidden">
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent" />
