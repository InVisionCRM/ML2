...
export function TicketPurchaseModal({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="bg-gradient-to-br from-slate-950 to-slate-900/95 border-white/20 text-white max-w-4xl max-h-[90vh] overflow-y-auto w-[95vw] overflow-x-hidden">
