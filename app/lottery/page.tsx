          ...
          <div className="text-center mb-12 sm:mb-16 md:mb-20 lg:mb-32">
            ...
            <div className="grid grid-cols-3 gap-2 sm:gap-3 max-w-xs mx-auto">
              ...
              <Dialog open={showHowToPlay} onOpenChange={setShowHowToPlay}>
                ...
                <DialogContent className="bg-gradient-to-br from-slate-950 to-slate-900/95 border-white/20 text-white max-w-4xl max-h-[85vh] overflow-y-auto funnel-display-regular">
                  <DialogHeader>
                    ...
                    <Card className="p-6 bg-gradient-to-br from-slate-950 to-slate-900/20 backdrop-blur-lg border-white/10">
                      ...
                      <div className="space-y-4">
                        <div className="bg-gradient-to-r from-cyan-950/30 to-blue-950/30 p-4 rounded-lg border border-cyan-400/20">
                          <h4 className="text-cyan-300 font-medium mb-2">🤖 Automated Lottery Keeper</h4>
                          <p className="text-white/80 text-sm mb-3">
                          ...
                          <div className="mt-3 p-3 bg-blue-950/20 rounded border border-blue-400/20">
                            ...
                            <ul className="text-white/70 text-xs space-y-1">
                              <li>• Generates random numbers for each ticket</li>
                              <li>• Helps maintain round activity and prize pools</li>
                              <li>• Automatically finalizes rounds when they expire</li>
                              <li>• Continues until it runs out of Morbius tokens</li>
                            </ul>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                        ...
                        <div className="flex items-start gap-3 p-3 bg-white/5 rounded-lg border border-white/5">
                          <Button
                            variant="outline"
                            size="sm"
                            className="text-white border-white/20 bg-gradient-to-br from-slate-950 to-slate-900/20 hover:bg-white/10 backdrop-blur-sm flex-shrink-0"
                          >
                        ...
                        {/* Claim Button */}
                        <div className="flex items-start gap-3 p-3 bg-white/5 rounded-lg border border-white/5">
                          <Button variant="outline" className="text-white bg-slate-900 border-white/10 hover:bg-gradient-to-br from-slate-950 to-slate-900/60 w-10 h-10 p-0 flex-shrink-0" title="Claim Winnings">
                        ...
                        <div className="flex items-start gap-3 p-3 bg-white/5 rounded-lg border border-white/5">
                          <Button
                            ...
                            className="text-white bg-slate-900 border-white/10 hover:bg-gradient-to-br from-slate-950 to-slate-900/60 w-10 h-10 p-0 flex-shrink-0"
                            title="Dashboard"
                          >
                            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        {/* Your Tickets Button */}
                        <div className="flex items-start gap-3 p-3 bg-white/5 rounded-lg border border-white/5">
                          <Button variant="outline" className="text-white bg-slate-900 border-white/10 hover:bg-gradient-to-br from-slate-950 to-slate-900/60 w-10 h-10 p-0 flex-shrink-0" title="Your Tickets">
                            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
